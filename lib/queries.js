...
export async function fetchBracketForYear(year) {
  ...
  for (const g of (games || [])) {
    const game = { id: g.id, s1: g.seed1, t1: g.team1, s2: g.seed2, t2: g.team2, sc1: g.score1, sc2: g.score2, w: g.winner, picks: picksMap[g.id] || {}, status: g.status, tipoff: g.tipoff_time }
...
export async function getActiveYear(tournaments) {
