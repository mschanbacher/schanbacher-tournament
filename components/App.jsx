...
function BracketDisplay({bracket,currentPlayer}){
  ...
  return(<div>
    ...
    <div style={{overflowX:"auto",paddingBottom:16}}>
      {showF4?(<div style={{padding:"8px 0"}}><Lbl>First Four — 1pt each</Lbl><div style={{display:"grid",gridTemplateColumns:"1fr",gap:10,maxWidth:260}}>{(bracket.play_in||[]).map((g,i)=><GameCell key={i} game={g} roundIdx={0} currentPlayer={currentPlayer} allPlayers={allPlayers}/>)}</div></div>)
